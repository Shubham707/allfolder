...
<meta name="description" content="jqxValidator is a plug-in which enables you to validate html forms.
   ...
   <link rel="stylesheet" href="widght/jqwidgets/styles/jqx.base.css" type="text/css" />
    <script type="text/javascript" src="widght/scripts/jquery-1.11.1.min.js"></script>   
    <script type="text/javascript" src="widght/jqwidgets/jqxcore.js"></script>
    <script type="text/javascript" src="widght/jqwidgets/jqxexpander.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxvalidator.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxbuttons.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxcheckbox.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/globalization/globalize.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxcalendar.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxdatetimeinput.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxmaskedinput.js"></script> 
    <script type="text/javascript" src="widght/jqwidgets/jqxinput.js"></script> 
    <script type="text/javascript" src="widght/scripts/demos.js"></script> 
