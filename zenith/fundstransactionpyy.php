...
$response = file_get_contents($url_api.'/usertransaction/getTxsListPYY', false, $context);
...
if (isset($responseData['tx'])) {
    $transactionList_PYY = $responseData['tx'];
}
...
<div class="row">
 <div class="col-md-12"><!-- All Sent Received Transferred -->
  ...
  <h3 class="text-center font-custom">YOUR PYY TRANSACTIONS</h3>
      ...
      <div class="tab-pane active" id="tab1">
        ...
        <tbody>
          <tbody>
            <?php
            $bold_txxs = "";
            if (count($transactionList_PYY)>0) {
                foreach (array_reverse($transactionList_PYY) as $transaction) {
            ...
            } elseif ((count($transactionList_PYY)== 0)) {
