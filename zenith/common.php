...
define("ADMIN_EMAIL", "support@zenithnex.com");
...
$support = "support@zenithnex.com"; //Your support eMail
...
/*api server*/
$bchmarket='199.188.206.184:1338';

/*close*/
function sendpmail($smto, $smsub, $smbody)
{
    $email_from ="support@zenithnex.com";
