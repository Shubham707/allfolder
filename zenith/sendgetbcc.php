                        ...
                        <div class="card-header">
                            <div class="row text-center">
                                <div class="col-md-8 text-center">
                                    <h2 class="font-custom">Send BCH</h2>

                                </div>
                                <div class="col-md-4 pull-right">
                                    <span class=" pull-right"><span class="font-weight-bold"><?php echo $user_current_balance_BCH; ?> BCH</span><br>My BCH balance</span>
                                </div>
                            </div>
                        </div>
    ...
    echo $error;
                        ...
                        <div class="card-body bg-white text-center text-success">
                            <div class="form-group row">
                                <label class="col-sm-5 form-control-label" for="input-small">Receiver BCH Address</label>
                                <div class="col-sm-6">
                                    <input id="btcaddress"  name ="btcaddress" class="form-control" placeholder="Paste your BCH Address" autocomplete="off" type="text" value="">

                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 form-control-label" for="input-large">Amount(BCH + network Fee of 0.001)</label>
                                <div class="col-sm-6">
                        ...
                        <input type="submit" class="btn btn-info btn-lg" id="btnsendbcc" name="btnsendbcc" value="Send"/>
                    </div>
                </form>
