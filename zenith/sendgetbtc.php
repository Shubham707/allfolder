                    ...
                    <div class="card  bg-success">
                        <div class="card-header">
                            ...
                            <div class="col-md-8 text-center">
                                    <h2  class="font-custom">Send BTC</h2>
                                    </div>
    ...
    echo $error;
                        ...
                        <div class="card-body bg-white text-center text-success">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="btcaddress"  name ="btcaddress" class="form-control" placeholder="Paste your BTC Address" autocomplete="off" type="text" value="">
