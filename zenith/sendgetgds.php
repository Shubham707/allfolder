                        ...
                        <div class="card-header">
                            <div class="row text-center">
                                <div class="col-md-8 text-center">
                                    <h2 class="font-custom">Send GDS</h2>
    ...
    echo $error;
                        ...
                        <div class="card-body bg-white text-center text-success">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="gdsaddress"  name ="gdsaddress" class="form-control" placeholder="Paste your GDS Address" autocomplete="off" type="text" value="">
                        ...
                        <input type="submit" class="btn btn-info btn-lg" id="btnsendgds" name="btnsendgds" value="Send"/>
                    </div>
                </form>
