...
if (isset($responseData['user'])) {
    $bcc_address = $responseData['user']['userBCHAddress'];
}
            ...
            <div class="col-sm-6 col-md-6 text-center">
                <div class="card text-white bg-success">
                    <div class="card-header text-center">
                        <h1 class="font-custom">Receive BCH<br>

                        </h1>
                        <span class="text-muted">Receive BCH to this address</span>
                    </div>
                    <div class="card-body text-center bg-white text-success">
                        ...
                        <span><?php echo $bcc_address;?></span>
                    </div>
                </div>
