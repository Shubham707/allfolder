      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-12">
          <div class="tab-content" id="myTabContent">
              ...
              <div class="row">
                ...
                <div class="col-md-3" style="margin-top: 14px;">
                  ...
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body ">
                      ...
                      <div class="input-group margin-top">
                        ...
                        <input type="text" step="0.00001" onkeypress="return isNumberKey(event)" onkeyup="bidAmountTotalBTC()" name="bidAmountBTC" id="bidAmountBTC"
                        class="form-control "
                        aria-label="Amount (to the nearest dollar)">
                        <span class="input-group-addon">BTC</span>
                      </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="input-group margin-top">
                      <span class="input-group-addon">Total</span>
                      <input type="text" step="0.00001"  onkeypress="return isNumberKey(event)"  onkeyup="askBTCTotalAmount()"  id="askBTCAmount" name="askAmountBTC"
            ...
            <div class="panel panel-default" style="position:relative">
              <div class=" text-center"><h3><b>MY SUCCESS ORDERS</b></div>
...
<script type="text/javascript">
  function bidAmountBTC() {
          var a = new BigNumber(document.getElementById('bidAmountBCH').value);
          var b = new BigNumber(document.getElementById('bidRateBCH').value);
     ...
     function bidAmountTotalBTC()
      ...
      function askBTCAmount() {
          var a = new BigNumber(document.getElementById('askBCHAmount').value);
          var b = new BigNumber(document.getElementById('askRateBCH').value);
          var result = (a).times(b);
          if (!isNaN(result)) {
      ...
      function askBTCTotalAmount()
      {
        var a = new BigNumber(document.getElementById('askBCHAmount').value);
        var b = new BigNumber(document.getElementById('askRateBCH').value);
        var res =new BigNumber(document.getElementById('askBTCAmount').value);
          if(res)
          {
            var equal=(res).dividedBy(b);
