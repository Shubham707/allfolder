...
<div class="container">
    ...
    echo "<br/><span class=\"text-black\">".$errorcontact['user_emailError']."</span>";
}?>
    ...
    echo "<br/><span class=\"text-black\">".$errorcontact['text_subjectError']."</span>";
}?> <br><br>
    ...
    echo "<br/><span class=\"text-black\">".$errorcontact['discriptionError']."</span>";
}?>
    ...
    echo "<br/><span style=\"color:green\" class=\"messageClass\">".$errorcontact2['user_emailError']."</span>";
                    ...
                    <div class="col-md-1 col-sm-1 hidden-xs">
                        <hr class=" hidden-xs">
                    <span style="color:#1b2530;" >or<span>
                    <hr class=" hidden-xs">
                    </div>
                    ...
                    <div class="col-md-6 col-sm-5">
                           ...
                           <div class="col-md-2 col-sm-2 support" >
                               <img src="img/email.png" alt=""><span style="color:#1b2530;" >Support@zenithnex.com<span>
                           </div>
                     </div>
               </div>
            </div>
