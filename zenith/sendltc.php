                ...
                <form action="send.php" method="post" class="form-horizontal">
                    <div class="card text-white bg-success">
                        <div class="card-header text-center">
                            <h1 class="font-custom">Send BTG</h1>
                        </div>
                        <div class="card-body bg-white text-center text-success">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php if (isset($errorsend['reciever_addressError'])) {
    echo "<br/><span class=\"messageClass\">".$errorsend['reciever_addressError']."</span>";
}?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php if (isset($errorsend['txtCharError'])) {
    echo "<br/><span class=\"messageClass\">".$errorsend['txtCharError']."</span>";
}?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php if (isset($errorsend['spendingpasswordError'])) {
    echo "<br/><span class=\"messageClass\">".$errorsend['spendingpasswordError']."</span>";
}?>
                                    </div>
                                </div>
