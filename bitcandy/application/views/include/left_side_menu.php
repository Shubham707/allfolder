          ...
          <div class="left_col scroll-view">
             <div class="navbar nav_title" style="border: 0;">
              ...
              <a href="<?php echo base_url()?>dashboard" class="site_title">
                <img src="<?php echo logo_url() ?>" alt="<?php echo project_name();?>" id="desklogo" class="img-circle profile_img" style="  background: #fc5c7d; 
  ...
  background: linear-gradient(to right, #fc5c7d, #6a82fb);">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <h2 style="padding:3px !important">Welcome, </h2><h2 style="padding:3px !important"><?php print_r($this->session->userdata['name']); ?></h2>
              </div>
            </div>
            <br />
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section" style="margin-bottom: 6%;">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>Currency</h3>
                 <ul class="nav side-menu">
			<!--<li><a href="<?php echo base_url()?>getbtc"><i class="fa fa-money"></i> Bitcoin (BTC)</a></li>-->
                   <?php
...
?>
             ...
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <li><a href="<?php echo base_url()?>bitcoincandy"><i class="fa fa-star"></i> Claim Bitcoin Candy</a></li>   
              <li><a href="http://199.188.204.87:3001" target="_blank"><i class="fa fa-pie-chart"></i> Explorer</a></li>  
