 ...
 -->
             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>Useful Links</h3>
                 <ul class="nav side-menu">
                  <li><a href="<?php echo admin_url();?>claimdetails"><i class="fa fa-send"></i> Claim Detail</a></li> 
                  
              <li><a href="<?php echo admin_url();?>userdetail"><i class="fa fa-users"></i> User Detail</a></li>     
           <!--   <li><a href="<?php echo admin_url()?>transactionreqlist"><i class="fa fa-file-text"></i> Transaction Requests</a></li>-->
              <li><a href="<?php echo admin_url()?>sendamount"><i class="fa fa-share"></i> Send Amount</a></li>
