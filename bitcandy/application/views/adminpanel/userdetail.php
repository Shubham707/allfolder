                       ...
                       <div id="txnlist">
                        ...
                        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                          ...
                          <tbody>
                           ...
                           <tr>
                            <td><?php echo $i++;?>
                              <input class="pull-right" type="checkbox" name="claimData[]" value="<?php echo $list->user_id."^".$list->amount_of_bch;?>">
                             <!--  <input class="pull-right" type="hidden" name="claimAmount[]" value="<?php echo $list->amount_of_bch;?>"> -->
                            </td>
                             <td>sasdfadf</td>
                             <td>adfdsf</td>
                             <td>sdf</td>
                             <th><a class="btn btn-sm btn-success" title="User Account unblock" href="#"  ><i class="fa fa-eye"></i></a>
                              <a class="btn btn-sm btn-success" title="User  Two factor Authentication unblock  "  href="#" ><i class="fa fa-lock"></i></a>
                              <a class="btn btn-sm btn-danger" title="User  Two factor Authentication block  "  href="#"><i class="fa fa-unlock"></i></a>
