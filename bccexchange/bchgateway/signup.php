...
$otp_token=md5(rand(100000,999999));
$error = array();
...
//  var_dump($_POST);
      ...
      $spendingpassword = @$_REQUEST['spendingpassword'];
      $confirmspendingpassword = @$_REQUEST['confirmspendingpassword'];
...
<div style="color:red; text-align;"><?php echo @$_REQUEST['msg']; ?></div>
      ...
      <div name="loginForm" role="form" autocomplete="off" novalidate="" class=" form-group has-feedback ptl form-horizontal clearfix ng-pristine ng-invalid ng-invalid-required">
        ...
        <div class="input-group input-group-lg">
                <div class="input-group-btn">
                  <i type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-envelope form-control-feedback" style="color:white !important;"></span>
                    </i>
                </div>
                <!-- /btn-group -->
                <input id="txtEmailID" name="txtEmailID" class="form-control" type="email"  placeholder="Email" required>
                
            </div>  
            <?php if(isset($error['emailError'])) { echo "<br/><span class=\"messageClass\" style=color:red;>".$error['emailError']."</span>";  }?>  
        <?php if(isset($error['emailError2'])) { echo "<br/><span class=\"messageClass2\" style=color:red;>".$error['emailError2']."</span>";  }?>
            <div><span id="result" style="float:left"></span></div><br>

            <div class="input-group input-group-lg">
                <div class="input-group-btn" >
                  <i  type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-lock form-control-feedback" style="color:white !important;"></span> 
                    </i>
                </div>

                <!-- /btn-group -->
                <input id="signuppassword" name="signuppassword" autocomplete="off" class="form-control" type="password"   placeholder="Password" required>
                 
              </div>
              <div><span id="result" style="float:left"></span></div>
               <?php if(isset($error['passwordError'])) { echo "<br/><span class=\"messageClass\" style=color:red;>".$error['passwordError']."</span>";  }?>  
              ...
              <div class="input-group input-group-lg">
                ...
                <!-- /btn-group -->
                 <input id="confirmpassword" name="confirmpassword" class="form-control" autocomplete="off" type="password"  placeholder="Confirm Password" required>
                 
              </div>
              <?php if(isset($error['confirmpasswordError'])) { echo "<br/><span class=\"messageClass\"style=color:red;>".$error['confirmpasswordError']."</span>";  }?>   
              <br>
              <div class="input-group input-group-lg">
                <div class="input-group-btn" >
                  <i type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-lock form-control-feedback" style="color:white !important;"></span> 
                ...
                <!-- /btn-group -->
                <input id="spendingpassword" name="spendingpassword" class="form-control" autocomplete="off" type="password"  placeholder="Spending Password" required>
              ...
              <div class="input-group input-group-lg">
                ...
                <!-- /btn-group -->
                <input id="confirmspendingpassword" name="confirmspendingpassword" class="form-control" autocomplete="off" type="password"  placeholder="Confirm Spending Password">
                 
              </div>
              
             <?php if(isset($error['confirmspendingpasswordError'])) { echo "<br/><span class=\"messageClass\">".$error['confirmspendingpasswordError']."</span>";  }?>
              <br>
              <div class="form-group has-feedback" style="margin-left: 20px; color:white !important;">
              ...
              <div class="mtl flex-center flex-end">
                  <input type="submit" class="btn btn-primary" id="btnlogin" name="btnsignup" value="Sign Up"/>
              </div>
              
     <a style="float:right" href="login.php" class="text-center"  style="color: white !important;">Merchant Login</a>
      </div>
    </form>
  </div>
