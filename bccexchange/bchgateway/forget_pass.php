...
<div class="login-box">
  ...
  <div class="login-box-body">
	...
	<div style="Color:red;"><?php echo @$_REQUEST['msg'];?></div>
    <form  method="post" action="lib/forget_pass.php"> 
      <div name="loginForm" role="form" autocomplete="off" novalidate="" class=" form-group has-feedback ptl form-horizontal clearfix ng-pristine ng-invalid ng-invalid-required">
        ...
        <div class="input-group input-group-lg">
                <div class="input-group-btn">
                  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-envelope form-control-feedback" style="color:white !important;"></span>
                    </button>
                </div>
                <!-- /btn-group -->
            ...
            <div  ng-class="{'has-error': errors.uid}"></div><br>
              <div class=" mtl flex-center flex-end">
                  <input type="submit" class="btn btn-primary" id="btnlogin" name="btnlogin" value="Send"/>
              </div>
              
		<div style="float:right; color:white !important;"><a href="login.php" style="color:white;">Login</a></div>    
      </div>
      </div>
    </form>
  </div>
