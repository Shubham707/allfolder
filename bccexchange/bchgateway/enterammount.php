...
if($key)
{
	 $sql="select * from merchantuser where accesskey='$key'";
 ...
 if ($key1==$key)
 {
  header("location:paysuccess.php?nad=".$wallet_address."&value2=".$price."&value3=".$invoiceid."&redirect=".$_REQUEST['redirect']);
 }
 else
 {
