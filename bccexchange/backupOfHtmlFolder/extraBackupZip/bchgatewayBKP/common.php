...
/* --------------------------block.io api starts-----------------
	...
	change  $apikey = '[BLOCK_IO_API_KEY]';  ---BTC 
			$pin = '[BLOCK_IO_SPENDING_PIN'];
			$version = 2 (default);
*/
 ...
 /* for testing bitcoin testnet */
 $apiKey = "c81b-9ca7-baed-3c68";
 $pin = "priyanka1210";
 $version = 2; 
...
$coin_fullname = "BCC wallet"; //Website Title (Do Not include 'wallet')
