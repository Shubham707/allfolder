...
include_once('common.php');
 ...
 echo $email_id =@$_REQUEST['txtEmailID'];
 echo $pass =@$_REQUEST['password'];
 echo $confirm =@$_REQUEST['confirm_pass'];
 //die();

if($pass == $confirm)
{
  $password_value = hash('sha256',addslashes(strip_tags($pass)));
  $sql="UPDATE  `merchantuser` SET `password`='$password_value' WHERE `username`='$email_id'";
  ...
  {
      $error['emailError']="Wrong Input Email Id!";
  }
...
else
{
    ...
    $error['emailError']=" Please Input Email!";
}
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form  method="post" action="forget.php" id="loginForm" name="loginForm"> 
      <div name="loginForm" role="form" autocomplete="off" novalidate="" class=" form-group has-feedback ptl form-horizontal clearfix ng-pristine ng-invalid ng-invalid-required">
        ...
        <div class="input-group input-group-lg">
                ...
                <!-- /btn-group -->
                <input id="txtEmailID" name="txtEmailID" class="form-control"  type="email" autocomplete="off" placeholder="Email_ID" required>
           ...
           autocomplete="off" required placeholder="Password">
              ...
              <div class="input-group input-group-lg">
                ...
                <!-- /btn-group -->
                <input id="confirmpassword" name="confirm_pass" class="form-control"  type="password" autocomplete="off" required placeholder="Confirm Password" required >
