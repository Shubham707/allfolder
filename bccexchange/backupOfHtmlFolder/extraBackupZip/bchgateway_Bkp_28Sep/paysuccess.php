...
<script>
//var hoursleft = 0;
var minutesleft = 15; //give minutes you wish
	...
	<div class="main">	
		<div class="w3_agile_main_grids">
			<div class="agile_main_top_grid" style="background-color:#072c4a;">
              ...
              <p style="color:white;font-size: 20px;font-weight: bold; text-align: center; margin:auto;font-style: italic;"><strong>bchpayz</strong></p>
				</div>
				<div class="clear">
				...
				<div class="wthree_total">
						<div class="row">
						<div style="color:#fff;font-size:18px; float:right;font-weight: bold;margin:auto;font-style: italic;"  id="divCounter">
						 </div>
...
<div class="read-more-wrap">
					 ...
					 <p style="color:#fff;font-size:18px;float:Left;font-weight: bold;margin:auto;font-style: italic;"> <b>Pay BCH </p>
						...
						<div class="agileits_w3layouts_tab1">
							<form action="#" method="post" class="creditly-card-form agileinfo_form">
                             ...
                             echo "<script></script>";
                                     ...
                                     {
                             echo '<img src="http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl=bitcoincash:<?php echo $address;?>,amount:<?php echo $ammount;?>" alt="QR Code" style="width:300px;border:0;">';
                                }
...
?>
										...
										<button class="button" style="background-color:#072c4a;"><a href="http//bccwallet.io" style="color: white;">
...
<script></script>
<form id="jsform" name="jsform" class="login-form" action="lib/payment.php" method="post">
