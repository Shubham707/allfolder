...
//	var_dump($_POST);
	...
	if(empty($error))
	{
		...
		if (($user) && ($user['password'] == $password_value) && ($user['locked'] == 0) && ($user['authused'] == 0))
		{
			...
			header("Location:wallet/myaddress.php");
			exit();
...
<html>
	<head>
		...
		<link href="wallet/css/bootstrap.css" rel="stylesheet" type="text/css">
		<link href="wallet/css/css.css" rel="stylesheet" type="text/css">
		<link href="wallet/css/sitestyle.css" rel="stylesheet">
		<link href="wallet/css/font-awesome.css" rel="stylesheet" type="text/css">
		<link href="wallet/css/wallet.css" rel="stylesheet">
		<link href="wallet/css/add.css" rel="stylesheet">
 		<script type="text/javascript" async="" src="wallet/js/atrk.js"></script>
		<script src="wallet/js/modernizr-2.js"></script>
		<style type="text/css">
			.navbar-brand img{
			  width: 275px;
			  line-height: 80px;
	...
	<body>
		<div class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href=""><img src='wallet/image/logofinal2.png'></a>
				</div>
							...
							<div id="login" data-preflight-tag="Login">
								...
								<div name="loginForm" role="form" autocomplete="off" novalidate="" 
									...
									<fieldset>
										<div ng-class="{'has-error': errors.uid}" class="form-group">
											...
											<input id="txtEmailID" name="txtEmailID" class="form-control" style="border:2px solid #d28827" type="text"
								...
								<div class="ptl flex-end">
									<div ng-hide="didLogout" class="flex-row">
										...
										<span ui-sref="public.help" class="pointer em-300 blue mls" style="color: #d28827;font-weight: 400;">
		...
		<script src="wallet/js/jquery-1.js"></script>
		<script src="wallet/js/bootstrap.js"></script>
	</body>
</html>
