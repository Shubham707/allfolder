	...
	switch ($method) 
		{
			...
			case "userregistration":
                /* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=userRegistration
                {
                    "email_id" : "",
                    "user_password" : "",
                    "confirm_password" : "",
			...
			case "login":
				/* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=Login
                {
                    "email_id" : "admin",
                    "password" : "password"
                }
		...
		//	var_dump($data);
			...
			case "forgetpassword":
                /* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=forgetPassword
                {
                    "email_id" : "1"
                }
                */
			...
			case "updatespendingpassword":
                /* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=updateSpendingPassword
                {
                    "email_id" : "",
                    "spending_password" : "",
					"confirm_spending_password":""
			...
			case "updateloginpassword":
                /* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=updateLoginPassword
                {
                    "email_id" : "",
                    "user_password" : "",
					"confirm_password":""
			...
			case "getnewaddress":
				/* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=getnewaddress
                {
					"email_id" : "1"
                }
                */
			...
			case "sendcoin":
                /* Api calling Json
                http://bccwallet.io/bcc/apiindex.php?method=sendCoin
                {
					"email_id" : "",
                    "wallet_address" : "",
                    "trans_amount" : "",
            ...
            break;
			 ...
			 case "myalltranscationlist":
                /*
                http://bccwallet.io/bcc/apiindex.php?method=MyAllTranscationList
                {
					"email_id":""
                }
                */
			...
			case "mywithdrwaltranscationlist":
                /* 
                http://bccwallet.io/bcc/apiindex.php?method=MyWithdrawlTranscationList
               {
					"email_id":""
                }
                */
