    								...
    								<div class="above-prod-table pctrns">
    									<div class="col s7 left prod-title-div no-padding" id="ace">
    										<a href="transactions.php">
    											<span class="btn btn-default" style="background-color: transparent!important;color: #9ee89e;;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif; font-weight:bold;text-decoration:underline" id="Type_All">All</span>
    										</a>
    										<a href="sent.php">
    											<span class="btn btn-default" style="background-color: transparent!important;color: #9ee89e;;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_Sent">Sent</span>
    											</a>
    										<a href="recieved.php">
    											<span class="btn btn-default" style="background-color: transparent!important;color: #9ee89e;;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_Receive">Received</span>
    												</a>
