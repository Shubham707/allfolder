				...
				<main id="content" class="topmg transactiontop main2-content">
					<div id="page-content">
						<div class="row" style="margin-bottom:0px;">
							<div class="col l12 m12 s12 tabmenu"  style="background-color:black">
								<div class="above-prod-table pctrns">
									<div class="col s7 left prod-title-div no-padding" id="ace">
										<a href="transactions.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_All">All</span></a>
										<a href="sent.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;font-weight:bold;text-decoration:underline" id="Type_Sent">Sent</span></a>
										<a href="recieved.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_Receive">Received</span></a>
