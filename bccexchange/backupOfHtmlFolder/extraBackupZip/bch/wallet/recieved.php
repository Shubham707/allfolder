				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms2" class="active"><a href="transactions.php" style="color: #9ee89e;" class="collapsible-header"><!--<i class="zmdi zmdi-swap-vertical icontransaction" style="font-size:30px;"></i>-->Transactions</a></li>
							...
							<div class="col l12 m12 s12 tabmenu">
								<div class="above-prod-table pctrns">
									<div class="col s7 left prod-title-div no-padding" id="ace">
										<a href="transactions.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_All">All</span></a>
										<a href="sent.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;" id="Type_Sent">Sent</span></a>
										<a href="recieved.php"><span class="btn btn-default" style="background-color: transparent!important;color: #d28827;font-size: 14px;border: 0px solid #ececec;box-shadow:none!important;padding: 0px 10px;font-family:'Open Sans', sans-serif;font-weight:bold;text-decoration:underline" id="Type_Receive">Received</span></a>
