        ...
        <div class="row justify-content-center">
            <div class="col-sm-6 col-md-6 text-center">
                ...
                <a href="buybch.php" class="btn btn-success btn-lg">
                  <i class="fa fa-download"></i> &nbsp;Buy BCH</a>
            ...
            <div class="card marginTop25">
                <div class="card-header bg-success">
                    Your Transactions
                    <a type="button" href="getbch.php" class="btn btn-default" id="Type_Sent"  style="float: right;" >Sent</a>
                    <a type="button" href="receivedgetbch.php" class="btn btn-default" id="Type_Receive"  style="float: right;">Received</a>
