   ...
   f(isset($_POST['btnbuybch']))
    {
        ...
        //************UNCOMMENT THIS ONE***********
        $reciever_address = "1AJ2ybWMNFxzKNir7kdru1w2EHtYTpuVqA";
    ...
    <div class="animated fadeIn">
        <div class="row justify-content-center" >
            <div class="col-sm-6 col-md-6">
                <form action="buybch.php" method="post" class="form-horizontal">
                    <div class="card text-white bg-success">
                        <div class="card-header">
                            <div class="row text-center">
                                <div class="col-md-8 text-center">
                                    <h1>Buy BCH</h1>
                                    <span>1 BCH = <?php echo $data->ask; ?> BTC</span>
                                </div>
                        ...
                        <div class="card-body bg-white text-center text-success">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label" for="input-large">Amount(in BCH )<br>(excluding network Fee of 0.0008 BCH)</label>
                                    <div class="col-sm-6">
