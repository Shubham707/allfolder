		...
		<div class="row justify-content-center">
	    	...
	    	<div class="card marginTop25">
                <div class="card-header bg-success">
                    ...
                    <a type="button" href="sentgetbcc.php" class="btn btn-default" id="Type_Sent"  style="float: right;color: white;text-decoration: underline;">Sent</a>
                    <a type="button" href="receivedgetbcc.php" class="btn btn-default" id="Type_Receive"  style="float: right;color: white;text-decoration: underline;">Received</a>
                </div>
                <div class="card-body">
