	...
	<div class="animated fadeIn">
		<div class="row justify-content-center">
            <div class="col-sm-6 col-md-6 text-center">
                ...
                <a href="buybch.php" class="btn btn-success btn-lg">
                  <i class="fa fa-paper-plane"></i> &nbsp;Buy BCH</a>
	    	...
	    	<div class="card marginTop25">
                <div class="card-header bg-success">
                    ...
                    <a href="getbch.php" class="btn btn-outline-success" id="Type_Sent"  style="float: right;color: white;text-decoration: underline;">Sent</a>
                    <a type="button" href="receivedgetbch.php" class="btn text-success" id="Type_Receive"  style="float: right;">Received</a>
                </div>
                <div class="card-body">
