                    ...
                    <div class="card text-white bg-success">
                        <div class="card-header">
                            <div class="row text-center">
                                <div class="col-md-8 text-center">
                                    <h1>Buy BCC</h1>
                                    <span>1 BCC = <?php echo $data->ask; ?> BTC</span>
                                </div>
                        ...
                        <div class="card-body bg-white text-center text-success">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label" for="input-large">Amount(in BCC )<br>(excluding network Fee of 0.0008 BCC)</label>
                                    <div class="col-sm-6">
