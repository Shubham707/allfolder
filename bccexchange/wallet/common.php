...
define("ADMIN_EMAIL", "bccwalletsuport@gmail.com");
...
$server_ip = "162.123.152.66";
$server_url = "http://".$server_ip."/".$dir_path."/";  // website url

//-------------RPC CREDS of BTC-------
$rpc_host_BTC = "162.123.152.66";
$rpc_port_BTC = "";
$rpc_user_BTC = "btcbccwallet";
$rpc_pass_BTC = "btcbccwallet123";

//--------------RPC CREDS of coin-----
$rpc_host = "162.123.152.66";
$rpc_user="bitcoinxbt";
$rpc_pass="bitcoinxbt123";
$rpc_port="";

$coin_fullname = "Bitcoin Cash"; //Website Title (Do Not include 'wallet')
$coin_short = "BCC"; //Coin Short 
$server_name = "http://bccwallet.io";

$blockchain_url = $server_name.":3001/tx/"; //Blockchain Url
$support = "bccwalletsuport@gmail.com"; //Your support eMail
...
function sendpmail($smto, $smsub, $smbody)
{
	...
	$email_from ="bccwalletsuport@gmail.com";
