...
curl_setopt_array( $ch, $options );
    ...
    <head>
      ...
      <title>BCCWallet.io | Bitcoin Cash Wallet</title>
  ...
  <nav class="topbar topbar-inverse topbar-expand-sm">
    <div class="container">
      <div class="col-md-12">
        ...
        <div class="col-md-6">
          <div class="topbar-right" style="float: right;">
            ...
            <button class="btn btn-sm btn-outline btn-white "  onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Signup</button>
          </div>
        </div>
      ...
      <div class="topbar-right" style:"text-align: right !important">
              ...
              <div class="card-body" >
                <div class="signin-form">
                    <div class="container">
                          ...
                          <button class="btn btn-sm" onclick="document.getElementById('id01').style.display='block';document.getElementById('id03').style.display='none'" style="width:auto;color:#2E4057;">Signup</button>
                           <button class=" btn btn-sm" onclick="document.getElementById('id04').style.display='block';document.getElementById('id03').style.display='none'" style="width:auto;color:#2E4057;">Forget Password</button>
                          </span>
                       </div> <!-- close container -->
                  </div> <!-- sign-up form -->
                </div>
                ...
                <div class="login-box card" >
                  ...
                  <div class="card-body" >
                    <div class="signup-form">
                      ...
                      <button class="btn btn-sm"onclick="document.getElementById('id02').style.display='block';document.getElementById('id01').style.display='none'" style="width:auto;color:#2E4057;">Already Signup | Login </button>
                    </div>
                  </section>
                </div>
                      ...
                      <div class="card-body" >
                        <div class="exchange-form">
                          <div class="container">
                           ...
                           <button class="btn btn-sm" onclick="document.getElementById('id01').style.display='block';document.getElementById('id03').style.display='none'" style="width:auto;color:#2E4057;margin-left: 35rem;">Signup</button>
                        <button class="btn btn-sm" onclick="document.getElementById('id04').style.display='block';document.getElementById('id03').style.display='none'" style="width:auto;color:#2E4057;margin-left: 65rem;margin-top: -4.5rem;">Forget Password</button>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <!-- Header -->
        <header class="header header-inverse h-fullscreen p-0 bg-primary overflow-hidden" style="background-image:url(img/bg_wallet.png); background-attachment: fixed; background-position: center; background-repeat: no-repeat; background-size: cover; height:530px;">
          ...
          <div class="container text-center">
            ...
            <div class="row h-full align-items-center">
              <div class="col-12 col-md-8 offset-md-2">
                ...
                <h1 class="display-4">Built for Bitcoin Cashers!</h1>
                <br>
                <p class="lead text-white fs-20">Utilising the best of minds in crypto-currency world, we bring you the first official Bitcoin Cash Wallet as a Service solution offered by Bitcoin Cash Foundation. Register now on BCCWallet.io</p>
                <br>
              </header>
              <!-- END Header -->
              <script type="text/javascript">
             ...
             <FORM NAME="myform" method="post">
              ...
              <div class="col-offset-xs-2 col-xs-8 col-sm-3">
               <div class="form-group input-group">
                <span class="input-group-addon">You have</span>
                <input class="input-group-addon" type="text" NAME="number1" VALUE="" onKeyup="sum()">
        ...
        <button class="btn btn-sm btn-white mr-4" onclick="document.getElementById('id03').style.display='block'" id="exchange" style="width:auto; margin-top: 20px;">Exchange</button>
      ...
      <section class="section">
          ...
          <div class="container">
            ...
            <div class="col-12 col-md-6 col-xl-6">
              <div class="flexbox gap-items-6">
               ...
               <div>
                <h5>Low Cost</h5>
                <p>UAHF with 8 MB block size makes BCC the cheapest means of money transfer.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 col-xl-6">
            <div class="flexbox gap-items-6">
              ...
              <div>
                ...
                <p>BCCWallet.io will ensure the working of two chains in a peaceful, optimized way.</p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 col-xl-6">
        ...
        <div class="col-12 col-md-6 col-xl-6">
          <div class="flexbox gap-items-6">
            <div>
             <img  class="large" src="assets/img/happiness.png" alt="logo">
           </div>
           <div>
            <h5>Great future expediencies</h5>
            <p>With its soaring values in first few days of launch, BCC has gained a great momentum by directly entering the cryptocurrency market at the third position.</p>
          </div>
        </div>
      </div>
      <div class="col-12 col-md-6 col-xl-6">
      ...
      |‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒‒
      !-->
      <section class="section section-inverse py-40" style="background-color:#1544c0">
        <div class="container">
          <div class="row gap-y align-items-center">
            <div class="col-12 col-md-9">
              <h4 class="fw-300 mb-0">Want a bite of BCC? You're in the right place!</h4>
            </div>
          ...
          <div class="row gap-y align-items-center">
            <div class="col-12 col-lg-3">
              <p class="text-center text-lg-left">
                <a href="index-2.html"><img src="assets/img/logoblck.png" alt="logo"></a>
              </p>
            </div>
            <div class="col-12 col-lg-3"></div>
            <div class="col-12 col-lg-3"></div>
            <div class="col-12 col-lg-3">
              <a href="http://bccwallet.io/"><p><b>&copy; bccwallet.io, All rights reserved.</b></p></a>
            </div>
          </div>
        </div>
      </footer>
...
<script language="JavaScript" type="text/javascript">
  TrustLogo("https://trustlogo.com/images/new-trustlogos/comodo_secure_seal_76x26_transp.png", "CL1", "none");
</script>
