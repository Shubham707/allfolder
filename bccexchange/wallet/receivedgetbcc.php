	...
	<div class="animated fadeIn">
		<div class="row justify-content-center">
            <div class="col-sm-6 col-md-6 text-center">
                ...
                <a href="buybcc.php" class="btn btn-success btn-lg">
                  <i class="fa fa-paper-plane"></i> &nbsp;Buy BCC</a>
	    	...
	    	<div class="card marginTop25">
                <div class="card-header bg-success">
                    ...
                    <a type="button" href="receivedgetbcc.php" class="btn text-success" id="Type_Receive"  style="float: right;">Received</a>
                </div>
                <div class="card-body">
